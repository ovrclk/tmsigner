...
echo "123456789" | gaiacli $home0 keys add validator &>/dev/null
echo "123456789" | gaiacli $home0 keys add extra &>/dev/null

# Add addresses to genesis
gaiad $home0 add-genesis-account $(gaiacli $home0 keys show validator -a) $coins &>/dev/null
gaiad $home0 add-genesis-account $(gaiacli $home0 keys show extra -a) $coins &>/dev/null

# Finalize genesis on n0 node
echo "123456789" | gaiad $home0 gentx --home-client $n0dir --name validator &>/dev/null
